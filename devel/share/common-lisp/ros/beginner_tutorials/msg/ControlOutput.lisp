...
(cl:defmethod cl:initialize-instance :after ((m <ControlOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<ControlOutput> is deprecated: use beginner_tutorials-msg:ControlOutput instead.")))
...
(cl:defmethod steering_angle_change-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:steering_angle_change-val is deprecated.  Use beginner_tutorials-msg:steering_angle_change instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlOutput>)))
  ...
  "beginner_tutorials/ControlOutput")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlOutput)))
  "Returns string type for a message object of type 'ControlOutput"
  "beginner_tutorials/ControlOutput")
