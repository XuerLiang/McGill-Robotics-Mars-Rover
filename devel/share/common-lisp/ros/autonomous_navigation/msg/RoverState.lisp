...
(cl:defmethod cl:initialize-instance :after ((m <RoverState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoverState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonomous_navigation-msg:<RoverState> is deprecated: use autonomous_navigation-msg:RoverState instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <RoverState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonomous_navigation-msg:x-val is deprecated.  Use autonomous_navigation-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <RoverState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonomous_navigation-msg:y-val is deprecated.  Use autonomous_navigation-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <RoverState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonomous_navigation-msg:theta-val is deprecated.  Use autonomous_navigation-msg:theta instead.")
  (theta m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RoverState>)))
  ...
  "autonomous_navigation/RoverState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RoverState)))
  "Returns string type for a message object of type 'RoverState"
  "autonomous_navigation/RoverState")
